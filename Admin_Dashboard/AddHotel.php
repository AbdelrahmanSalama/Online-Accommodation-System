    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
      {
        if(isset($_POST['ADD']))
        {
          ...
          $masterUser->AddHotel($_POST['NAME'],$_POST['AVAILABLE'],$_POST['no_rooms']);
    ...
    <div class="register-photo" style="background-color: rgb(240,95,64);">
        <div class="shadow-lg form-container">
            ...
            <form class="shadow-lg" method="post">
                <h2 class="text-center"><strong>Add</strong> Hotel. </h2>
                <div class="form-group"><input class="form-control" type="text" name="NAME" placeholder="Name"></div>
                <div class="form-group"><input class="form-control" type="text" name="AVAILABLE" placeholder="Availablity"></div>
                <div class="form-group"><input class="form-control" type="text" name="no_rooms" placeholder="Rooms Number"></div>
                <div class="form-group">
                </div>
                <button href='users.php' type="submit" class="btn btn-primary btn-block" name="ADD" role="button" >ADD</button>
            </form>
        </div>
    </div>
