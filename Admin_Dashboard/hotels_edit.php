    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
      {
        if(isset($_POST['edit']))
        {
          ...
          $data=$masterUser->gethotelsid($whereName);
          $HOTELID= $data[0]['ID'];
          //Var_dump($HOTELID);
          $masterUser->UpdateHotel(
            array('name', 'availability','rooms_no'),
             array($NEWname,$availability,$ROOMS), 
             array('id'),
             array($HOTELID));
      }//end of if
?>
    ...
    <div class="register-photo" style="background-color: rgb(240,95,64);">
        <div class="shadow-lg form-container">
            ...
            <form class="shadow-lg" method="post">
                ...
                <div class="form-group"><input class="form-control" type="text" name="NAME" placeholder="Hotel Name"></div>
                <br>
                <div class="form-group"><input class="form-control" type="text" name="NEWNAME" placeholder="New Name"></div>
                <div class="form-group"><input class="form-control" type="text" name="availability" placeholder="Availability"></div>
                <div class="form-group"><input class="form-control" type="text" name="NO_ROOMS" placeholder="Number Of Rooms"></div>
