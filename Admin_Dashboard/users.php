        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background-color: #f05f42;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="home.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                  ...
                  foreach($normalUsers as $row)
                  {
                    echo "
                        <tr>
                            ...
                            <td>
                                <button class='btn btn-danger btn-sm  btn-flat' data-id='".$row['email']."'>
                                    <i class='fa fa-trash'></i>
                                    <a style='text-decoration: none;color:white;' class ='delete'
                                        href='users_delete.php?action=delete&Email=".$row['email']."'>
                                        DELETE
                                    </a>
                                </button>
                            </td>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-primary py-2">
                            <div class="card-body">
                                <a style="text-decoration: none;" href="Adduser.php">
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-warning py-2">
                            <div class="card-body">
                                <a style="text-decoration: none;" href="users_edit.php">
                                <div class="row align-items-center no-gutters">
                                    <div  href="index.php" class="col mr-2">
                                        
                                        <div class="text-uppercase text-warning font-weight-bold text-L mb-1">
                                            <span>UPDATE USER</span></div>
