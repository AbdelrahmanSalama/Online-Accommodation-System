...
<body>
	<nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav">
        <div class="container"><a style="color: #f05f40;" class="navbar-brand js-scroll-trigger" href="#page-top">Where2find</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false"
						...
						<form method="POST">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<span style="color: #f05f40;" class="form-label">rooms</span>
								</div>
								</div>
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-btn">
									<a href="payment.php">
									<button onclick="location.href='payment.php';" style="background-color: #f05f40;" formaction="" class="submit-btn" name="book">Book</button>
									</a>
								</div>
							</div>
						</form>
...
<?php 
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
	    ...
	    { 
	      ...
	      $user = new user() ;
	      $user->addBooking($hotelid ,$_POST['checkin'],$_POST["checkOut"],$_POST["guests"],$_POST["rooms"],$_SESSION['ID']);

	    }
	}
	$hotel = new hotels();
	//header('location:payment.php');
  	//$hotel->updatehotelroom($_POST["rooms"],$hotelid);	
?>
