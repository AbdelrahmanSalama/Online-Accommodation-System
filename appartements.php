    ...
    <div class="projects-horizontal">
        <div class="container">
            <div class="intro" style="margin-bottom: -20;">
                <h2 class="text-center">APARTEMENTS</h2>
            </div>
            <div class="row projects">
            <?php
                require_once 'Classes/apartement.php';
                $hotel = new apartement();
                $data = $hotel->getapartements();
                $counter = 1;
                foreach($data as $row)
                {
                    ...
                    <div class='col-sm-6 item'>
                        <div class='row'>
                            <div class='col-md-12 col-lg-5'>
                                ...
                                <a href='booking.php/'><img class='img-fluid' src='assets/img/app".$counter.".jpg'></a>
                            </div>
                                <div class='col'>
                                    <h3 class='name'>
                                    ".$row['name']."
                                    </h3>
                                    <p class='description' style='margin-bottom: 10PX;'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.  </p><a class='btn btn-primary border rounded' role='button' href='booking2.php?bookingId=". $row['ID']. "'>BOOK NOW!</a>
                                </div>
                        </div>
                    </div>
